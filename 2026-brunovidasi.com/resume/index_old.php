...
<html lang="en">
  ...
  <head>
    ...
    <meta property="og:image" content="http://brunovida.si/img/website_old.png" />
    <link rel="image_src" href="./img/website_resume.png" />
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
      <a class="navbar-brand js-scroll-trigger" href="#page-top">
        ...
        <span class="d-none d-lg-block">
          <!-- <img class="img-fluid img-profile rounded-circle mx-auto mb-2" src="../img/avatar_bg.png" alt="Bruno Vieira"> -->
    ...
    <div class="container-fluid p-0">
      ...
      <?php
            # TWITTER #################################################################################
            # OAuth credentials removed from the public repo. Configure them in the hosting environment if needed.
            /*
...
*/
$twitter_text = "Q: What is the best prefix for global variables? A: //";
      ...
      <section class="resume-section p-3 p-lg-5 d-flex d-column" id="about">
        <div class="my-auto">
          ...
          <div class="subheading mb-5">Software Programmer · Full Stack Developer · Sydney, Australia ·
            <a href="mailto:contact@brunovidasi.com">contact@brunovidasi.com</a>
          </div>
          <p class="mb-5">IT specialist with over <?php echo $years; ?> years of experience in planning, designing, testing and implementing systems and processes required to accomplish company projects and objectives.</p>
          <p class="mb-5">Originally from Rio de Janeiro, and living in Sydney for over 5 years. Permanent resident of Australia.</p>
          ...
          <ul class="list-inline list-social-icons mb-0">
            <li class="list-inline-item">
              <a href="https://www.linkedin.com/in/brunovidasi/?locale=en_US" target="_blank" title="LinkedIn">
            ...
            <li class="list-inline-item">
              <a href="https://github.com/brunovidasi" target="_blank" title="GitHub">
                <span class="fa-stack fa-lg">
                  <i class="fa fa-circle fa-stack-2x"></i>
            ...
            <li class="list-inline-item">
              <a href="https://codepen.io/brunovidasi" target="_blank" title="CodePen">
                <span class="fa-stack fa-lg">
                  <i class="fa fa-circle fa-stack-2x"></i>
            ...
            <li class="list-inline-item">
              <a href="https://follow.brunovidasi.com/" title="All social media">
                <span class="fa-stack fa-lg">
                  <i class="fa fa-circle fa-stack-2x"></i>
      ...
      <section class="resume-section p-3 p-lg-5 d-flex flex-column" id="cv">
        <div class="my-auto">
          ...
          <ul class="fa-ul mb-0">
            ...
            <li>
              <a href="https://codepen.io/brunovidasi" target="_blank">
                <i class="fa-li fa fa-codepen color-linkedin"></i>
                CodePen
              </a>
            </li>
            <li>
