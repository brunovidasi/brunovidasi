...
<body>
  ...
  <div class="all_content">
    ...
    <section class="resume-section p-3 p-lg-5 d-flex flex-column" id="cv">
      <div class="my-auto cv-list-wrapper">
        <div>
          <h2 class="cv-headline">Software Programmer &middot; Full Stack Developer &middot; Sydney, Australia</h2>
          <ul class="fa-ul mb-0 cv-list">
          <li>
