...
# Faz o comando sql
$sql = "SELECT * FROM softwares WHERE tipo='site' ORDER BY data_desenvolvimento DESC";
...
<head>
	...
	<!-- TÍTULO -->
	<title>Portfólio WebSites</title>
    ...
    <div class="wrapper">
		...
		<div class="container" aria-haspopup="true" style="float:<?php echo $float; ?>">
			...
			<div class="lower">
				...
				<p>Link: <strong class="highlight"><?php echo $link; ?></strong>.</p>
