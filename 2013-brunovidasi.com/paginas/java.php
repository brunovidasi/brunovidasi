...
# Faz o comando sql
$sql = "SELECT * FROM softwares WHERE tipo='java' ORDER BY data_desenvolvimento DESC";
...
<header role="banner">
  <div class="wrapper">
    <h1>Bruno Vieira</h1>
    <h2>Portfólio de Aplicações em Java SE</h2>
    ...
    <div class="wrapper">
		...
		<div class="container" aria-haspopup="true" style="float:<?php echo $float; ?>">
			...
			<div class="lower">
				...
				<p>Compilado na versão <strong class="highlight"><?php echo $versao; ?></strong>.</p>
				
				<?php if(empty($link)){ ?>
					<p><img src="http://www.brunovidasi.com/images/download.gif" /> <strong class="highlight">Download Ainda Não Disponível</strong></p>
				<?php }else{ ?>
					<p><img src="http://www.brunovidasi.com/images/download.gif" /><a href="<?php echo $link; ?>" target="_blank"> <strong class="highlight">Download Aqui</strong></a></p>
				<?php } ?>
